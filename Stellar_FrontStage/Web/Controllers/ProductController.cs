...
namespace Web.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public ProductController(ProductPageService productPageService, ProductSearchServices productrespondservices, SearchRequestServices searchrequestservices, IHttpContextAccessor httpContextAccessor, StoreNavbarService storeNavbarService, SemanticRecommendProductsService semanticRecommendProductsService)
        {
